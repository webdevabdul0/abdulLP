  ...
  return (
    <div className="mt-24 w-full">
      <div className="flex flex-col items-center">
        ...
        <p className="text-xl text-center  font-light text-white/80 ">
      ...
      <div className="grid grid-cols-3 mt-12 gap-8">
        <div className="flex flex-col items-start gap-2 px-5 py-7 bg-gradient-to-br  from-[#A6A6FF]/5 to-[#E8E8FD]/2  rounded-2xl">
        ...
        <div className="flex flex-col items-start gap-2 px-5 py-7 bg-gradient-to-br  from-[#A6A6FF]/5 to-[#E8E8FD]/2  rounded-2xl">
          ...
          <h4 className="text-xl font-bold text-white ">Developer APIs</h4>
          <p className="text-lg text-white/80 font-medium">
